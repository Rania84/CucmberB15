...
public class Log {
    ...
    public  static  void  startTesterCase(String testCaseName){
        log.info("**************************************");
        log.info("***************************************");
    ...
    //JAR files allow us to package multiple files in order to use
    // it as a library, plugin, or any kind of application. On the other hand,
