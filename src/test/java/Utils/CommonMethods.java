...
public class CommonMethods  extends PageInitializer {
    ...
    public static void openBrowserAndLaunchApplication() {
        ...
        initializePageObjects();// This will initialize all the pages we have in
        // our page , PageInitializer class along with the launching of application
        // to configure the file and pattern it has
        DOMConfigurator.configure("log4j.xml");
        Log.startTesterCase("This is beginning of my Test case ");
